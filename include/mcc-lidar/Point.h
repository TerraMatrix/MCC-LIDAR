...
namespace mcc
{
  ...
  inline Point::Point(double x, double y, double z)
      : x_(x), y_(y), z_(z), classification_(NotYetClassified)
  {
  }
  inline void Point::setCoordinates(const XyzPoint &point)
  {
    x_ = point.x;
    y_ = point.y;
    z_ = point.z;
  ...
  inline PointClassification Point::classification() const { return classification_; }

  inline void Point::classifyAs(PointClassification classification)
  {
