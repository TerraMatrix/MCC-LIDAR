	...
	char* argv[])
{
	...
	try {
		...
		mcc::ProgressBar progress(nullptr, 60);

		algorithm.classifyPoints(unclassifiedPoints, progParams.scaleDomain2Spacing, progParams.curvatureThreshold, 0, progress);
