...
namespace mcc
{
	class MCC_LIDAR_EXPORTS PointVector : public IPointVector,
	...
	public:
		...
		// return constant reference of points_
		const std::vector<Point>& getPoints() const {
			return points_;
		}

		// return reference of points_
		...
		// swap points
		void swapPoints(std::vector<Point>& other) {
			points_.swap(other);
		}
